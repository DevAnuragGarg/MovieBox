...
class GetPopularMoviesUseCaseTest {
    ...
    fun setup() {
        ...
        getPopularMoviesUseCase = GetPopularMoviesUseCase(movieRepository, baseSchedulerProvider)
    }
    ...
    fun testGetPopularMoviesSuccess() {
        ...
        val testObserver = getPopularMoviesUseCase.buildUseCase(GetPopularMoviesUseCase.Param("1")).test()
    ...
    fun testGetPopularMoviesFailure() {
        ...
        val testObservable =
            getPopularMoviesUseCase.buildUseCase(GetPopularMoviesUseCase.Param("1")).test()
